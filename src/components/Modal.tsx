  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Enhanced Footer */}
        <div className="border-t border-gray-200 px-4 sm:px-6 py-4 sm:py-5 bg-gray-50 rounded-b-xl sm:rounded-b-2xl">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-2 sm:justify-center">
            <Button 
              variant="outline" 
              onClick={onClose}
              className="w-full sm:w-auto order-2 sm:order-1 border-gray-300 text-gray-700 hover:bg-gray-100 hover:border-gray-400"
            >
              إلغاء
            </Button>
            <Button 
