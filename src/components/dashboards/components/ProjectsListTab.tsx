...
const ProjectsListTab: React.FC<ProjectsListTabProps> = ({
  projects,
  onViewProject,
  onDeleteProject,
  onProjectCreated,
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            className="bg-green-600 hover:bg-green-700 text-white font-bold px-4 py-2 rounded-md flex items-center gap-2 transition-colors"
          >
            ...
            <div className="text-lg sm:text-xl font-bold text-green-600">
              {
                projects.filter((p) => {
                  const timePercentage =
                    p.expectedDays > 0
                      ? (p.timeElapsed / p.expectedDays) * 100
                      : 0;
                ...
                {projects.length > 0 ? (
                  projects.map((project, index) => (
                    ...
                    >
                      ...
                      <TableCell>
                        <span
                          className={`inline-flex items-center px-2.5 py-1 rounded-full text-sm font-medium ${getCompletionColor(
                            project.completion || 0
                          )}`}
                        >
                          {project.completion || 0}%
                            ...
                            <AlertDialogContent className="rtl:text-right">
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  ...
                                  سيتم حذف جميع البيانات المرتبطة به ولا يمكن
                                  استعادتها.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
        ...
        {projects.length > 0 ? (
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={`inline-flex items-center px-2 py-1 rounded-full text-sm font-medium ${getCompletionColor(
                        project.completion || 0
                      )}`}
                    >
                      {project.completion || 0}%
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent className="rtl:text-right">
                      <AlertDialogHeader>
                        <AlertDialogTitle>حذف المشروع</AlertDialogTitle>
                        <AlertDialogDescription>
                          هل أنت متأكد من حذف المشروع "{project.name}"؟ سيتم حذف
                          جميع البيانات المرتبطة به ولا يمكن استعادتها.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter className="flex-row-reverse">
                        <AlertDialogAction
          ...
          <Card className="p-8 text-center bg-white">
            <div className="flex flex-col items-center gap-3 text-gray-400">
              ...
              <Button
                onClick={handleCreateProject}
                className="bg-green-600 hover:bg-green-700 text-white font-bold px-6 py-2 rounded-md flex items-center gap-2 transition-colors mt-2"
              >
                <Plus className="w-4 h-4" />
                إنشاء مشروع جديد
              </Button>
