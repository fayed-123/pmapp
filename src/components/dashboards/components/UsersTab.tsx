...
import { UserPlus, Users, Building2, Wrench, Check, X, Mail, Phone, UserCheck, Clock, Trash2, CheckCircle } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xl sm:text-2xl font-bold text-gray-800">إدارة المستخدمين</h3>
      ...
      <Card className="p-4 sm:p-6 shadow-sm border-0 bg-white">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h4 className="text-lg font-semibold text-gray-800">إضافة مستخدم جديد</h4>
        </div>
                  ...
                  filteredUsers.map(user => {
                    ...
                    return (
                      <TableRow key={user.id} className="border-b hover:bg-gray-50 transition-colors">
                        ...
                        <TableCell>
                          <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ${roleConfig.bgColor} ${roleConfig.textColor} ${roleConfig.borderColor} border`}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <div className={`inline-flex items-center gap-2 px-2 py-1 rounded-full text-xs font-medium mt-1 ${roleConfig.bgColor} ${roleConfig.textColor} ${roleConfig.borderColor} border`}>
