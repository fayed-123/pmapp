  ...
  return (
    <div className="max-w-md mx-auto">
      <form onSubmit={handleSubmit} className="space-y-4 bg-gray-50 py-6 px-8 rounded-xl border">
        <FormField
          label={formData.role === 'mainConsultant' ? "اسم المشرف العام" : 
                 formData.role === 'consultant' ? "اسم الاستشاري" : "الاسم"}
          name="nameOrEmail"
          type="text"
          value={formData.nameOrEmail}
          onChange={handleChange}
          placeholder={formData.role === 'mainConsultant' ? "أدخل اسم المشرف العام" : "أدخل الاسم كما سجله المشرف العام"}
          required
        />
